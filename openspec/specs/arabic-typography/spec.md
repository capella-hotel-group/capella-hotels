...
Global RTL typography overrides and directional icon flip rules in `styles/styles.css`. Ensures Arabic text renders correctly using the existing font stack, and directional icons are mirrored in RTL context.
