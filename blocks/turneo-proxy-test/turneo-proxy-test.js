const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["scripts/vendor/dompurify.min-7lz6z_oP.js","scripts/vendor/rolldown-runtime-sZ5AbN7N.js"])))=>i.map(i=>d[i]);
/*! @adobe/aem-boilerplate v1.3.0 - built 2026-08-24T09:51:15.167Z */
import { n as __toESM } from "../../scripts/vendor/rolldown-runtime-sZ5AbN7N.js";
import { t as __vitePreload } from "../../scripts/vendor/preload-helper-CTmLbv-A.js";
...
async function loadDOMPurify() {
	if (!window.DOMPurify) await __vitePreload(() => import("../../scripts/vendor/dompurify.min-7lz6z_oP.js").then((m) => /* @__PURE__ */ __toESM(m.default)), __vite__mapDeps([0,1]));
