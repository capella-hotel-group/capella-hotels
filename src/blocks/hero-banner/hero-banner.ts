...
function pickSrc(desktopSrc: string, mobileSrc: string): string {
  return mqMobile.matches && mobileSrc ? mobileSrc : desktopSrc;
}

// ─── Background video ─────────────────────────────────────────────────────────
function buildBgVideo(desktopSrc: string, mobileSrc: string): HTMLVideoElement {
...
// ─── Modal video ──────────────────────────────────────────────────────────────
function buildModal(desktopSrc: string, mobileSrc: string): HTMLDivElement {
...
function initScrollSnap(block: HTMLElement): void {
